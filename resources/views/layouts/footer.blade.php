<footer class="bg-indigo-100 text-gray-600 px-6 lg:px-8 py-12">
    <div class="max-w-screen-xl mx-auto ">
        <div
            ...
            <div class="col-span-8 md:col-span-3 lg:col-span-3 md:px-8 py-4 md:py-0">
                <img class="h-40" src="{{asset("assets/images/portrait.png")}}" alt="UptimeMate logo">
            </div>

            <!-- ABOUT -->
            <div class="col-span-8 md:col-span-3 lg:col-span-2 md:px-8 py-4 md:py-0">
                <h5 class="text-xl font-semibold text-gray-700">Sobre Mi</h5>
                <nav class="mt-4">
                    <ul class="space-y-2">
                        <li>
                            <a href="#" class="font-normal text-base hover:text-gray-400">Andres Villarroel</a>
                        </li>
                        <li>
                            <a href="#" class="font-normal text-base hover:text-gray-400">kuvickdabest@gmail.com</a>
                        </li>
                        <li>
                            <a href="#" class="font-normal text-base hover:text-gray-400">Arica / CL</a>
                        </li>
                    </ul>
                </nav>
            </div>
    ...
    <div
        ...
        <p class="text-sm text-center md:text-right">&copy;2021 Andrw | All rights reserved</p>
    </div>
</footer>
